...
export function SearchSection() {
  return (
    <div className="bg-[#F5F5F5] px-4 py-6 flex flex-col gap-4 border-b border-gray-200" dir="rtl">
      <Button 
        variant="outline" 
      ...
      <div className="relative">
        ...
        <Input 
          type="text" 
          placeholder="بحث عن..." 
          className="pr-10 h-12 bg-white border-[#D0D0D0] text-base shadow-sm text-right"
        />
      </div>
    </div>
  );
