        ...
        <div className="w-full bg-primary rounded-lg overflow-hidden shadow-lg">
          ...
          <div className="relative h-48 bg-primary flex items-center justify-center p-6">
            ...
            <div className="flex flex-col items-center justify-center z-10">
              ...
              />
              <div className="mt-2 text-center text-white font-bold tracking-wider uppercase">
                <div className="text-xl leading-tight">FIFA Arab Cup</div>
                <div className="text-xl leading-tight">Qatar 2025</div>
              </div>
            </div>
          </div>
        </div>
